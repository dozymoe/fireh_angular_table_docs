...
Revision ID: 8ffd7c20ad02
Revises: ca2957818415
Create Date: 2016-04-28 01:28:32.558894

"""

# revision identifiers, used by Alembic.
revision = '8ffd7c20ad02'
down_revision = 'ca2957818415'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('notes', sa.Column('country', sa.Integer, nullable=True))
    op.create_foreign_key('note_country_fk', 'notes', 'countries', ['country'], ['id'])


def downgrade():
    op.drop_constraint('note_country_fk', 'notes')
    op.drop_column('notes', 'country')
